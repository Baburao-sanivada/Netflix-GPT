...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="w-full aspect-video pt-[36%] lg:pt-[18%] pl-14 md:pl-20 absolute text-white">
      <h1 className="font-bold text-xl md:text-2xl lg:text-4xl my-2 md:my-4">
        {title}
      </h1>
      ...
      <div className="flex my-2 md:my-4 ">
        ...
        <button className="bg-gray-700 ml-2 md:ml-4 py-2 md:px-8 px-3 rounded-md flex items-center">
          <AiOutlineInfoCircle className="text-xl md:text-2xl md:mx-1 text-white" />{" "}
